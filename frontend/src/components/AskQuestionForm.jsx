...
export default function AskQuestionForm({ onSubmit }) {
  ...
  return (
    <div className="sticky top-16 z-30 pt-4 pb-6 -mx-4 px-4 sm:mx-0 sm:px-0 backdrop-blur-xl bg-zinc-950/80 border-b border-white/5 mb-6">
      <form onSubmit={handleSubmit} className="glass-panel p-2 sm:p-3 rounded-2xl flex flex-col sm:flex-row gap-3 relative overflow-hidden group">
        ...
        <input
          ...
          className="flex-1 px-4 py-3 bg-transparent border-none focus:outline-none focus:ring-0 text-zinc-100 placeholder-zinc-500 text-lg relative z-10"
          required
