      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <header className="border-b border-white/5 bg-zinc-950/50 backdrop-blur-md">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">Live Q&A Session</h1>
        ...
        <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-2 flex flex-col">
          ...
          <div className="flex-1 space-y-6 pb-20 sm:pb-10">
            ...
            {questions.length === 0 && (
              <div className="text-center py-20 px-4 border-2 border-dashed border-white/10 rounded-3xl bg-zinc-900/30 animate-fade-in">
                <div className="mx-auto w-20 h-20 bg-zinc-800/50 rounded-full flex items-center justify-center mb-6">
