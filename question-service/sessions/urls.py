...
from questions.views import QuestionListCreateView, QuestionMarkAnsweredView
...
urlpatterns = [
    ...
    path('<str:invite_code>/questions/<int:pk>/answered/', QuestionMarkAnsweredView.as_view(), name='session-question-answered'),
]
